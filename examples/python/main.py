"""
Example: How to call the opensea-top-trending-nfts-scraper actor using Apify API Client

For full documentation of the Apify Client for Python, see: https://docs.apify.com/api/client/python
For full documentation of the actor, see: https://apify.com/lexis-solutions/opensea-top-trending-nfts-scraper
...
def run_actor():
    """Run the opensea-top-trending-nfts-scraper actor and retrieve results."""
    ...
    actor_id = "lexis-solutions/opensea-top-trending-nfts-scraper"
    print(f"Starting actor: {actor_id}")

    run = client.actor(actor_id).call(
        run_input={
            "startUrls": [{"url":"https://opensea.io/rankings"},{"url":"https://opensea.io/rankings/trending"}],
        }
    )
